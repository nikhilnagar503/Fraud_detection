...
MLFLOW_TRACKING_URI = "https://dagshub.com/nikhilnagar503/Fraud_detection.mlflow"
repo_owner = "nikhilnagar503"
repo_name = "Fraud_detection"

dagshub.init(repo_owner=repo_owner, repo_name=repo_name, mlflow=True)
mlflow.set_tracking_uri(MLFLOW_TRACKING_URI)
mlflow.set_experiment("Logistic Regression with PowerTransformer1")
